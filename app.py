...
from supabase_auth import Any, datetime
...
def _run_workflow_job(job_id: str, method_name: str, body: dict = None):
    """Helper para ejecutar un método del WorkflowService en background."""
    try:
        JOBS[job_id]["status"] = "running"
        workflow = WorkflowService()
...
def home():
    # Servir la aplicación oficial desde el directorio estático.
